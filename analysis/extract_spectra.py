...
## CO
# Cloud c1
extract_spectrum(cloudc1, fn_12CO, line_name='12CO-BEARS', restfreq=1.152712040000E+11*u.Hz)
# Cloud c2
extract_spectrum(cloudc2, fn_12CO, line_name='12CO-BEARS', restfreq=1.152712040000E+11*u.Hz)
# Cloud d
