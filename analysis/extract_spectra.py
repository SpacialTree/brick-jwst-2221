...
average_spectrum_cloudc1.write('/orange/adamginsburg/jwst/cloudc/alma/spectra/spectrum_cloudc1.fits')

average_spectrum_cloudc2 = extract_spec(cube, pos_cloudc2, rad_cloudc2)
average_spectrum_cloudc2.write('/orange/adamginsburg/jwst/cloudc/alma/spectra/spectrum_cloudc2.fits')

average_spectrum_cloudd = extract_spec(cube, pos_cloudd, rad_cloudd)
average_spectrum_cloudd.write('/orange/adamginsburg/jwst/cloudc/alma/spectra/spectrum_cloudd.fits')

average_spectrum_filament = extract_spec(cube, pos_filament, rad_filament)
average_spectrum_filament.write('/orange/adamginsburg/jwst/cloudc/alma/spectra/spectrum_filament.fits')
